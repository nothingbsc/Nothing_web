...
const milestones = [
  {
    ...
    description: `Create the website, twitter and begin the whitepaper.`
  },
  {
    id: 2,
    date: 'June, 2023',
    title: 'Launch and Build Community',
    description: `Launch the project, gain holders and build an active community.`
  },
  {
    id: 3,
    date: 'TBA',
